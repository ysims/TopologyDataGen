...
for experiment in range(1, 12):
    ...
    path = "./all_data/single/50-cubed/octopus/torus/{}/".format(experiment)
    ...
    for i in range(0, 20):
        print("Run {}.".format(i))
        sp_path = "./50-cubed/octopus/torus/{}/{}".format(experiment, i)
        subprocess.run(
            "python generate.py single --octopus_num {} --cube_size 50 --random_walk_config {} --shape_config {} --save --save_num {}".format(
